...
module PuppetSpec
  module SSL
    ...
    FIVE_YEARS_IN_SECONDS_TONY_VU = 5 * 365 * 24 * 60 * 60
    CA_EXTENSIONS = [
    ...
    def self.self_signed_ca(key, name = generic_cert_name)
      ...
      cert.not_after  = not_before + FIVE_YEARS_IN_SECONDS_TONY_VU
    ...
    def self.create_csr(key, name = generic_cert_name)
    ...
    def self.create_crl_for(ca_cert, ca_key)
      ...
      crl.next_update = not_before + FIVE_YEARS_IN_SECONDS_TONY_VU
    ...
    def self.create_store(certs, crls)
